    ...
    def __init__(self, 
        ...
        for i, filter_size in enumerate(filter_sizes):
            with tf.name_scope("conv-maxpool-%s-u" % filter_size):
                ...
                out_tensor = tf.concat(axis=2, values=pooled_outputs_r_wclasses)
        ...
        self.h_pool_u = tf.concat(axis=3, values=pooled_outputs_u)
        ...
        self.h_pool_r = tf.concat(axis=3, values=pooled_outputs_r)
